 ...
 * @author bdtech
 */
public class User1_borrow extends javax.swing.JFrame {
   ...
   static int AvailableCopyInt ;
    ...
    public User1_borrow() {
      ...
      String s = "SELECT DISTINCT BookName FROM user2"; // getting book name in the combo box drop down
    ...
    private void Profile_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Profile_buttonActionPerformed
        ...
        User1_insert_update_delete obj=new User1_insert_update_delete();
        obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new User1_borrow().setVisible(true);
            }
        });
   ...
   Statement stmt = null;
        ...
        try
        {
            ...
            {
                msgin=din.readUTF(); // read the msg from lender
                
                msg_area.setText(msg_area.getText().trim()+"\n"+msgin);
                
                
                if(acc.equals(msgin.trim()))// if the reply is 'accepted'
                {
      ...
      con = DriverManager.getConnection("jdbc:mysql://localhost:3306/netprodb","root","");
      st = con.createStatement();
      String s = "SELECT BookISBN FROM user2 where BookName='"+msgout2+"'";
      rs = st.executeQuery(s);
       ...
       String BookISBN = null;
        ...
        s = "SELECT Author FROM user2 where BookName='"+msgout2+"'";
       ...
       String Author = null;
        ...
        s = "SELECT AvailableCopy FROM user2 where BookName='"+msgout2+"'";
      ...
      String sql;
      if(userId.trim().equals("User1")&&AvailableCopyInt>0)// if the user name matches and the book is available
      {
      ...
      */
      ...
      //new
          ...
          //inserting into user1 table
               String qry="INSERT INTO user1 (BookName,BookISBN,Author,AvailableCopy) value(?,?,?,?)";
             
               //updating user2 table
               String qry2="UPDATE user2 set `AvailableCopy`=? WHERE BookName=?";
            try {
            ...
            // this part is done to receive the book file from user2   
        ...
        FileOutputStream fos = new FileOutputStream("F:\\User1\\"+msgout2+".pdf");
